...
$(function() {
    ...
    $("input,textarea").jqBootstrapValidation({
        ...
        submitSuccess: function($form, event) {
            ...
            var primeiroNome = nome; // For Success/Failure Message
            // Check for white space in name for Success/Fail message
            if (primeiroNome.indexOf(' ') >= 0) {
                primeiroNome = nome.split(' ').slice(0, -1).join(' ');
            }
            $.ajax({
                url: "https://apps.snarqie.com/mail.php",
                type: "POST",
                data: {
                    nome: nome,
                    assunto: assunto,
                ...
                error: function() {
                    ...
                    $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
                        .append("</button>");
                    $('#success > .alert-danger').append("<strong>Desculpe " + primeiroNome + ", parece que o meu servidor de email não está respondendo. Por favor, tente novamente mais tarde!");
